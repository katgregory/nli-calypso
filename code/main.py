...
def main(_):
  ...
  assert not FLAGS.attentive_matching or FLAGS.stmt_processor in ["lstm", "bilstm", "stacked"], "Statement processor must be lstm or bilstm if attention is used."
  assert not FLAGS.infer_embeddings or FLAGS.attentive_matching, "Attention must be enabled to infer embeddings"
